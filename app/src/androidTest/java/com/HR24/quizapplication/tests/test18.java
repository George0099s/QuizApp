...
public class test18 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1 = (Button) findViewById(R.id.two);
    ...
    public void onBackPressed(){
        AlertDialog.Builder builder = new AlertDialog.Builder(test18.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.two:
                ...
                Intent intent = new Intent(this, test19.class);
                startActivity(intent);
                break;
            case R.id.old:

                btn2.setBackgroundResource(R.drawable.bg_button_red);
                intent = new Intent(this, test19.class);
                startActivity(intent);
                break;
            case R.id.twelve:
