...
public class test17 extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onBackPressed(){
        AlertDialog.Builder builder = new AlertDialog.Builder(test17.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.eleven:
                ...
                Intent intent = new Intent(this, test18.class);
                startActivity(intent);
                break;
            case R.id.old:
                btn2.setBackgroundResource(R.drawable.bg_button_red);
                intent = new Intent(this, test18.class);
                startActivity(intent);
                break;
            case R.id.twelve:
