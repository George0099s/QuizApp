...
public class test5 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn4 = (Button) findViewById(R.id.sorry_chinese);
    ...
    public void onBackPressed(){
        AlertDialog.Builder builder = new AlertDialog.Builder(test5.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.young:
                ...
                intent = new Intent(this, test6.class);
                startActivity(intent);
                break;
            case R.id.down:
