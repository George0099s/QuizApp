...
public class test19 extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onBackPressed(){
        AlertDialog.Builder builder = new AlertDialog.Builder(test19.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.eleven:
                ...
                Intent intent = new Intent(this, test20.class);
                startActivity(intent);
                break;
            case R.id.old:
                Variables.rightAnswer += 1;
                btn2.setBackgroundResource(R.drawable.bg_button);
                intent = new Intent(this, test20.class);
                startActivity(intent);
                break;
            case R.id.bye:
