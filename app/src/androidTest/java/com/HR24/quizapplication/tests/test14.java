...
public class test14 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn4 = (Button) findViewById(R.id.young);
    ...
    public void onBackPressed(){
        AlertDialog.Builder builder = new AlertDialog.Builder(test14.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.hello_chinese:
                ...
                Intent intent = new Intent(this, test15.class);
                startActivity(intent);
                break;
            case R.id.money:
                btn2.setBackgroundResource(R.drawable.bg_button_red);
                intent = new Intent(this, test15.class);
                startActivity(intent);
                break;
            case R.id.down:
