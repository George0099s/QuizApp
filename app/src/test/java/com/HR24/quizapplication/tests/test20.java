...
import com.HR24.quizapplication.CountRightAnswers;
import com.HR24.quizapplication.MainActivity;
import com.HR24.quizapplication.R;
import com.HR24.quizapplication.Variables;

public class test20 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn3 = (Button) findViewById(R.id.bye);
        btn3.setOnClickListener(this);

        btn4 = (Button) findViewById(R.id.twelve);
    ...
    public void onBackPressed(){
        AlertDialog.Builder builder = new AlertDialog.Builder(test20.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.eleven:
                ...
                Intent intent = new Intent(this, CountRightAnswers.class);
                startActivity(intent);
                break;
            case R.id.money:
                Variables.rightAnswer += 1;
                btn2.setBackgroundResource(R.drawable.bg_button);
                intent = new Intent(this, CountRightAnswers.class);
                startActivity(intent);
                break;
            case R.id.bye:
