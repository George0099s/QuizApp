...
public class test13 extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onBackPressed(){
        AlertDialog.Builder builder = new AlertDialog.Builder(test13.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.hello_chinese:
                ...
                Intent intent = new Intent(this, test14.class);
                startActivity(intent);
                break;
            case R.id.money:
                btn2.setBackgroundResource(R.drawable.bg_button_red);
                intent = new Intent(this, test14.class);
                startActivity(intent);
                break;
            case R.id.down:
